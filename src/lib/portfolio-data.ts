...
export const skillGroups: SkillGroup[] = [
  ...
  },
  {
    ...
    skills: [
      { label: "Google Cloud Platform (GCP)", value: 80 },
      { label: "Vertex AI / ML Pipelines", value: 72 },
      { label: "BigQuery ML / Analytics", value: 74 },
      { label: "LLM Integration & Semantic Search", value: 70 },
      { label: "NLP & Text Analytics", value: 66 },
    ],
  },
  {
    id: "tools-devops",
